...
setup(name='pyGSTi',
      ...
      packages=['pygsti', 'pygsti.algorithms', 'pygsti.baseobjs', 'pygsti.construction', 'pygsti.drivers',
                'pygsti.extras', 'pygsti.extras.drift', 'pygsti.extras.rb', 'pygsti.extras.rpe', 'pygsti.io',
                'pygsti.objects', 'pygsti.optimize', 'pygsti.report', 'pygsti.tools'],
